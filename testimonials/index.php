...
<script>
     (adsbygoogle = window.adsbygoogle || []).push({
          google_ad_client: "ca-pub-9051970355689655",
...
<div class="vc_row wpb_row vc_row-fluid vc_custom_1500441409040"><div class="container"><div class="row"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner ">
    Phoenix Worldwide Movers takes great pride in providing an exceptionally service to our clients. We value our customers and are grateful of all the great feedback that we get from them.
<span class="main-color">Just take a look at what our customers say about us:</span>
<div align="center">
    <br/>
    <a href="testimonial.php" class="fh-btn btn">Submit a Testimonial</a></div>
    </div></div></div></div></div>
...
$sql='SELECT `Name`,`Email`, `Testimonial`,`Action` FROM `testimonial` ORDER BY DATE(`DATE`) DESC LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($conn, $sql);
...
while($row = mysqli_fetch_array($result)) {
    ...
    if ($row['Action'] == '2')
    {
        echo ' <div class="col-xs-12 col-sm-6 col-md-12">
					<div class="testi-item">
						<span class="testi-icon"><i class="flaticon-quotations "></i></span>
						<div class="testi-content">
							<div class="testi-des">' . $row["Testimonial"] . '</div>
	                        <div class="info clearfix">
								<span class="testi-name">' . $row["Name"] . '</span>
								<span class="testi-job">' . $row["Email"] . '</span>
							</div>
						</div>
					</div>
                </div>';
...
for ($page=1;$page<=$number_of_pages;$page++) {
  echo 'Pages <a href="index.php?page=' . $page . '">' . $page . '</a> ';
}
