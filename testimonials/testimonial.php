...
<!-- Mirrored from demo2.steelthemes.com/cargohub/testimonials/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Feb 2018 08:41:07 GMT -->
...
<head>
	...
	<title>Testimonials &#8211; Phoenix</title>
...
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embedd7a6.json?url=http%3A%2F%2Fdemo2.steelthemes.com%2Fcargohub%2Ftestimonials%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed5a9d?url=http%3A%2F%2Fdemo2.steelthemes.com%2Fcargohub%2Ftestimonials%2F&amp;format=xml" />
...
.header-v4 .footer-widgets .cargohub-social-links-widget {
	...
	<style type="text/css" data-type="vc_shortcodes-custom-css">.vc_custom_1500441409040{padding-top: 80px !important;padding-bottom: 30px !important;}</style><noscript><style type="text/css"> .wpb_animate_when_almost_visible { opacity: 1; }</style></noscript></head>

<body class="page-template page-template-template-fullwidth page-template-template-fullwidth-php page page-id-25  no-sidebar header-transparent header-sticky hide-topbar-mobile error404-no-bg blog-classic header-v1 wpb-js-composer js-comp-ver-5.4.2 vc_responsive">
...
<li id="menu-item-1750" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent  menu-item-1750"><a href="../testimonials/">TESTIMONIALS</a>
...
<div class="vc_row wpb_row vc_row-fluid vc_custom_1500441409040"><div class="container"><div class="row"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="fh-testimonials-grid fh-testimonials ">
...
<div class="row">
<div class="col-md-12 col-sm-12 col-xs-12">
<p class="field"><span class="wpcf7-form-control-wrap your-name"><input type="text" name="your-name" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Your Name*" required/></span></p>
<p class="field"><span class="wpcf7-form-control-wrap your-email"><input type="email" name="your-email" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Email Address*" required/></span></p>
    


<p class="field single-field"><span class="wpcf7-form-control-wrap your-message"><textarea name="your-message" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false" placeholder="Your Comments..." required></textarea></span></p>
</div>
<div class="col-md-12 col-sm-12 col-xs-12">
     <?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $testimonial = $_POST['your-message'];
        
        $sql = "INSERT INTO `testimonial`( `Name`, `Email`, `Testimonial`) VALUES ('$name','$email','$testimonial')";
...
if ($conn->query($sql) === TRUE) {
   echo "<span style='color:green'> Your valuable comments seccessfully posted</span>";
} else {
...
<!-- Mirrored from demo2.steelthemes.com/cargohub/testimonials/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Feb 2018 08:41:12 GMT -->
</html>
