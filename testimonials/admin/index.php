...
<meta name="msapplication-TileImage" content="./../wp-content/uploads/sites/7/2017/08/favicon.png" />
		...
		<div class="container">
			<div class="row">
				...
				<a class="home" href="../../index.html" itemprop="url"><span itemprop="title">Home</span></a>
                        ...
                        <a class="home" href="../" itemprop="url"><span itemprop="title">Testimonial</span></a>
			</span><i class="fa fa-angle-right" aria-hidden="true"></i>
		<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			<span itemprop="title">admin</span>
                    </span> <span style="float:right;"><a href="logout.php">Sign out</a></span>
	</nav>				</div>
...
$sql='SELECT * FROM `testimonial` ORDER BY DATE(`DATE`) DESC LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($conn, $sql);
echo "<table width='100%' ><tr><th>No</th><th>Date</th><th>Name</th><th>Email</th><th>Testimonial</th><th>Status</th><th>Action</th></tr>";
while($row = mysqli_fetch_array($result)) {
  ...
  echo '<tr><td>' . $page. '-' . $No . '</td><td>' . $row['Date']. '</td><td>' . $row['Name'] . ' </td><td>' . $row['Email'] . ' </td><td>' . $row['Testimonial'] . ' </td><td>' . $action . '<td><input type=image alt="submit" name = "edit" id = "edit" src="../../wp-content/themes/cargohub/img/edit.png" value=' . $row['ID'] . '></input> </td></tr>';
    $No = $No + 1;
}
 echo "</table><br/>" ;
