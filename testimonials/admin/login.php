...
if(isset($_POST['submit']))
{
    ...
    if($result)
    {
        ...
        $_SESSION['logged'] = $username;
         setcookie('logged', $encuser, time() + (86400 * 30), "/"); 
...
<div class="page-header title-area">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<h1 class="page-title">Admin Loggin</h1>				</div>
			</div>
		</div>
	</div>
	<div class="breadcrumb-area">
		...
		<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			<span itemprop="title">Loggin</span>
		</span>
	</nav>				</div>
...
<div class="row">
<div class="col-md-12 col-sm-12 col-xs-12">
<p class="field"><span class="wpcf7-form-control-wrap your-name"><input type="text" name="user" value="" size="60" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="User Name*" required/></span></p>
<p class="field"><span class="wpcf7-form-control-wrap your-email"><input type="Password" name="Password" value="" size="60" class="wpcf7-form-control wpcf7-text " aria-required="true" aria-invalid="false" placeholder="Password*" required/></span></p>
